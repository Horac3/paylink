...
/**
 * Dev-only test number picker. Renders only when import.meta.env.DEV is true.
 * Groups sandbox numbers by expected outcome for quick selection during testing.
 */
export function SandboxPicker({ onSelect }: SandboxPickerProps) {
  ...
  const groups: Record<string, SandboxNumber[]> = {
    COMPLETED: [],
    SUBMITTED: [],
    FAILED: [],
  }
